...
| :--- | :--- | :--- |
| **[W3PN&nbsp;Commons](https://commons.w3pn.org)**<br/> | Asynchronous Discussion & Proposals (Zulip) | **Public.** Anyone can join. |
| **[Signal](https://signal.org/) groups**| Real-time Coordination & Chat<br />(Important decisions must be summarized in Commons) | **Private.** Invite-only within specific teams.|
